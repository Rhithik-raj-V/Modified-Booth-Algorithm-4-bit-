...
HD_PWD='D:/RHITHIK/MY_WORK/MODIFIED_BOOTH_4BIT/project/Final_Pjt/final_booth_algo_4bit/final_booth_algo_4bit.runs/design_1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
